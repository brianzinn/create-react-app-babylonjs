          ...
          <Col xs={12}>
            <Scene id="sample-canvas" enableOfflineSupport={false} engineOptions={{
              ...
              <GUI3DManager name="gui3d">
                <CylinderPanel name="panel" margin={0.2} columns={7} radius={4}>
                {
              ...
              <Box height={0.2} width={3} depth={0.1} position={new Vector3(-1.5, 0, 0)} visibility={this.state.modelLoadProgress === 1 ? 0 : 0.6}
