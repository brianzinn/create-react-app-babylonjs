...
const MashupButton = (props) => (
    <Button3D onControlAdded={onControlAdded} childrenAsContent={true} onPointerDownObservable={props.onPointerDown}>
        <StackPanel background="#CCCCCC" isVertical={true} height="256px">
