        ...
        <div className="row">
          <div className="col-xs-12 col-md-6">
            <Scene id="sample-canvas" onMeshPicked={this.meshPicked}>
              <ArcRotateCamera name="camera1" radius={6} beta={Math.PI / 4} target={Vector3.Zero()} minZ={0.001} onCreated={this.setCamera} />
              ...
              {this.state.showModal === true &&
                <Plane name="dialog" size={1} showBoundingBox={true} onCreated={this.setPlane}>
                  <AdvancedDynamicTexture createForParentMesh={true}>
                    <Rectangle background="white" height="35%" color="#666666" thickness={2} cornerRadius={10} >
                      <StackPanel>
