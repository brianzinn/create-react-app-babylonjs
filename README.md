...
## Starter Kit
'react-babylonjs' aims to be an unopinionated module for integrating React and BabylonJS.  You can choose a declarative or imperative programming style or a combination of both.  This is a sample project to help people get started.
